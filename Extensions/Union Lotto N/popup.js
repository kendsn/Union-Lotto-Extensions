...
document.addEventListener('DOMContentLoaded', function () {
	...
	port.onMessage.addListener(function(ret) {  //conncet port & show new score infomation
		...
		$("#_cq2lotto").html("重慶時時彩"); 
		$("#_bjcar3lotto").html("北京賽車PK");
		$("#_bjkl8lotto").html("北京快樂八");
		$("#_xynclotto").html("幸運農場");
		$("#_jsk3lotto").html("江蘇快三");
		$("#_gd10lotto").html("廣東快樂十分");
		$("#_tj10lotto").html("天津快樂十分");
		$("#_cqlotto").html("重慶時時彩cq");
